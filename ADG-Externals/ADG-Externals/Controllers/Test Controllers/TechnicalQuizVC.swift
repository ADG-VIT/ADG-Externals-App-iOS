...
class TechnicalQuizVC: UIViewController {
    ...
    @objc func appMovedToBackground() {
        ...
        if self.bgCounter == 1 {
            ...
            print("test over")
            self.bgCounter = 0
            if self.skipButton.currentTitle == "Skip" {
...
extension TechnicalQuizVC{
    @objc func updateUI(){
        ...
        self.questionNumberLbl.text = ("Question Numer :\(self.count+1)/\(self.questions.count)")
